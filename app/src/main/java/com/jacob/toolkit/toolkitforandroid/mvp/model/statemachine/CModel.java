 ...
 * @date: 2018/5/8
 */
public class CModel extends BasePresenter implements BaseModel{

    private IModelView mIModelView;

    public CModel(IModelView mIModelView) {
    ...
    public void start() {
        ...
        mIModelView.onNextAction(StateMachineManager.TRIGGER_D);
